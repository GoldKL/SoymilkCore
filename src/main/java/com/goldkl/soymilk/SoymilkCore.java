...
@Mod(SoymilkCore.MODID)
public class SoymilkCore
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "soymilk_core";
    ...
    */
    ...
    public static final RegistryObject<CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            ...
            .icon(() -> ItemRegistry.EXAMPLE_SKILL_SWORD_ITEM.get().getDefaultInstance())
            .displayItems((parameters, output) -> {
                output.accept(ItemRegistry.EXAMPLE_SKILL_SWORD_ITEM.get());
                // Add the example item to the tab. For your own tabs, this method is preferred over the event
            }).build());
    public SoymilkCore(FMLJavaModLoadingContext context)
    {
